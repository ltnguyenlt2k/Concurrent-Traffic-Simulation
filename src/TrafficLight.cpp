...
void TrafficLight::cycleThroughPhases()
{
    ...
    std::mt19937 eng(rd());
    std::uniform_int_distribution<> distr(4000, 6000); // Duration between 4 and 6 seconds
    ...
    while (true) {
        ...
        // Toggle traffic light phase if cycle duration elapsed
        ...
        // Wait for 1ms before next cycle
